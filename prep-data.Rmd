...
gt(bls_ind_job_loss) %>% 
  cols_label(
    ...
    emp_2019_09 = md("Employed Persons <br>(September, 2019)"),
    emp_2020_09 = md("Employed Persons <br>(September, 2020)"),
...
ipums_raw <- read_ipums_ddi("data/usa_00002.xml") %>%
  read_ipums_micro(verbose = FALSE, var_attrs = NULL) %>%
